 ...
 *
 * O glass dos cards usa backdrop-filter com blur baixo (ver .glass-card):
 * o <video> fica como elemento normal (sem espelho em canvas) — mesma
 * estratégia validada no hub da Frutas Beca. Diagnóstico A/B: ?debug=1.
 */
